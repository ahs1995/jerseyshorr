      ...
      <form className="flex flex-col gap-4">
        ...
        <FormRow>
          ...
          <select
            name="country"
            id="country"
            className="rounded-sm border-[0.5px] border-primary-50 bg-accent-800 bg-white-50 p-2 text-primary-800 outline-none"
          >
            <option value="india" className="bg-accent-800">
              india
            </option>
