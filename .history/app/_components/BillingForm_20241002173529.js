...
function BillingForm() {
  return (
    <div>
      <h3 className="text-md mb-6 font-semibold capitalize">
        Shipping information
      </h3>
      <form className="flex max-w-[500px] flex-col gap-4">
        <FormRow>
          <FormLabel htmlFor="first_name">
            first name <span className="inline-block text-accent-400">*</span>
          </FormLabel>
