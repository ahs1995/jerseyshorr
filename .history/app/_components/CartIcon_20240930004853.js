...
function CartIcon() {
  ...
  return (
    <div className="relative">
      ...
      {totalItemsInCart !== 0 && (
        <span className="border-1 absolute right-1 top-[1rem] flex h-4 w-4 items-center justify-center rounded-full bg-accent-500 p-[0.5rem] text-[0.6rem] text-accent-50 outline-none">
          {totalItemsInCart}
        </span>
      )}
    </div>
