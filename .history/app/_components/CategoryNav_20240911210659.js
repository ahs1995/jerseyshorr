    ...
    >
      ...
      <div className="container mx-auto px-4 py-2">
        <ul className="flex justify-center space-x-14">
          <li>
            <Link className="cursor-pointer hover:text-accent-300" href="#">
              Home
            </Link>
          </li>
          <li className="cursor-pointer hover:text-accent-300">Shop</li>
          <li>
            <Link className="cursor-pointer hover:text-accent-300" href="#">
              Track your order
            </Link>
          </li>
          <li className="cursor-pointer hover:text-accent-300">FAQ</li>
