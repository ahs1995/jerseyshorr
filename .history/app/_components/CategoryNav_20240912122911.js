    ...
    >
      ...
      <div className="container mx-auto px-4 py-2 text-sm">
        <ul className="flex justify-center space-x-14 uppercase">
          ...
          <li
            className="flex cursor-pointer flex-row items-center gap-1 transition-colors duration-300 hover:text-accent-300"
            onMouseEnter={handleMouseEnter}
            onMouseLeave={handleMouseLeave}
          >
            shop
            {/* <ArrowDownIcon className="h-3 w-3 text-primary-50" /> */}
            <ChevronDownIcon className="h-3 w-3 text-primary-50" />
          </li>
          <li>
            <Link
              className="cursor-pointer transition-colors duration-300 hover:text-accent-300"
