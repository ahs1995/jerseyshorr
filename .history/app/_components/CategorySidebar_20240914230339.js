    ...
    >
      <div className="relative text-primary-900">
        ...
        <div className="flex bg-primary-50 p-4">
          ...
          />
          <span className="mx-auto text-sm uppercase">shop by categories</span>
        </div>
        <ul className="my-10 flex flex-col gap-4 py-6 text-sm font-normal capitalize text-primary-800">
          <li className="px-4">
