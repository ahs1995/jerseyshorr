    ...
    <div className="grid grid-cols-1 gap-8 md:grid-cols-12 md:gap-0 md:shadow-2xl">
      ...
      <div className="bg-white-50 md:col-span-3">
        ...
        <nav className="flex h-full flex-col">
          ...
          <div className="border-gray-200 mt-auto border-t p-4">
            <button
              // onClick={handleDeleteAccount}
              className="text-gray-600 hover:bg-gray-50 hover:text-red-600 w-full rounded-lg px-4 py-2 text-left text-sm transition-colors xl:text-base"
            >
              Delete Account
            </button>
          </div>
