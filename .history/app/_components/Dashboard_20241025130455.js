    ...
    <div className="grid grid-cols-1 gap-8 md:grid-cols-12 md:gap-0 md:shadow-2xl">
      ...
      <div className="flex flex-col bg-white-50 md:col-span-3">
        ...
        <div className="flex flex-grow flex-col justify-between">
          ...
          <div className="mx-auto mt-4 p-2 hover:underline md:mt-0 md:p-4">
            <button
              onClick={handleDeleteAccount}
              className="w-full rounded-lg px-4 py-2 text-left text-xs text-accent-400 transition-colors md:text-sm xl:text-base"
            >
              Delete your account
            </button>
          </div>
