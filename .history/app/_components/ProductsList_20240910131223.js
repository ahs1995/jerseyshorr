  ...
  return (
    ...
    <div className="border-2 border-[#403cff]">
      {newArrivals.length > 0 && (
        // Product container
        <div className="border-2 border-[#3bdee3] py-4">
          <h3 className="text-3xl font-bold">New Arrivals</h3>

          <div className="mx-10 my-10 flex flex-wrap justify-between border-2 border-[#e38c3b]">
      ...
      {Object.entries(byStyle).map(([style, products]) => (
        <div key={style} className="border-2 border-[#3bdee3] py-4">
