...
async function ProductList() {
  ...
  return (
    // products container
    <div className="mx-auto w-[90%] border-2 border-[#403cff]">
      {/* new arrival group */}
      {newArrivals.length > 0 && (
        ...
        <div className="pt-8">
          ...
          {/* Card container */}
          <div className="grid grid-cols-2 gap-4 border-2 border-[#e38c3b] sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 lg:justify-center xl:grid-cols-5">
      ...
      {Object.entries(byStyle).map(([style, products]) => (
        ...
        <div key={style} className="border-2 border-[#3bdee3] pt-8">
          ...
          <div className="mb-10 inline-block">
            ...
            <hr className="m-2 border-t-2 border-accent-500" />
            <p className="text-xs">
              {style === "Retro"
          ...
          {/* card container */}
          <div className="flex flex-wrap justify-between border-2 border-[#e38c3b]">
