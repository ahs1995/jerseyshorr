...
async function ProductList() {
  ...
  return (
    // products container
    <div className="mx-auto w-[90%] border-2 border-[#403cff] p-8 xl:w-[80%]">
      {/* new arrival group */}
      {newArrivals.length > 0 && (
        // Product container
        <div className="pb-8">
          {/* contents */}
          <div className="mx-auto mb-10 max-w-[300px] text-center">
            <h3 className="mb-2 text-3xl font-bold">New Arrivals</h3>
            <hr className="mx-auto my-2 w-[80%] border-t-2 border-accent-500" />
            <p className="text-xs">
              Grab all new 24-25 season jersey at best price
            </p>
          </div>
          {/* Card container */}
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-5">
      ...
      {teams.length > 0 && (
        ...
        <div className="pt-8">
          ...
          <div className="mx-auto mb-10 max-w-[300px] text-center">
            ...
            <hr className="m-2 mx-auto w-1/2 border-t-2 border-accent-500" />
            <p className="text-xs">Grab a team jersey at best price</p>
          </div>
          {/* card container */}
          <div className="grid grid-cols-3 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-5">
            {teams.map((team) => (
