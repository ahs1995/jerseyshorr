  ...
  return (
    <div className="relative py-6 text-primary-900">
      ...
      <div className="mt-[20rem] flex flex-col items-center gap-4">
        ...
        {/* social media links */}
        <div className="flex">
          <span className="border-2 border-r-0 border-primary-100 px-4 py-2 outline-none">
            <Image
          ...
          <span className="border-2 border-primary-100 px-4 py-2 outline-none">
            <Image
          ...
          <span className="border-2 border-l-0 border-primary-100 px-4 py-2 outline-none">
            <Image
