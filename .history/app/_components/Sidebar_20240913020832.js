  ...
  return (
    <div className="relative py-6 text-primary-900">
      ...
      <div className="mt-[19rem] flex flex-col items-center gap-4">
        ...
        {/* social media links */}
        <div className="flex">
          <span className="border-[1px] border-r-0 border-primary-100 px-4 py-1 outline-none">
            <Image
          ...
          <span className="border-[1px] border-primary-100 px-4 py-1 outline-none">
            <Image
          ...
          <span className="border-[1px] border-l-0 border-primary-100 px-4 py-1 outline-none">
            <Image
