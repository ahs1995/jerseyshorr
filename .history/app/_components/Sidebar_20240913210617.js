...
function Sidebar({ closeSidebar }) {
  return (
    <aside
      className={`sidebar-container fixed left-0 top-0 z-[100000] h-full w-[350px] bg-[#fff] shadow-md transition-transform duration-700 ${
        closeSidebar ? "translate-x-0" : "-translate-x-full"
      } `}
    >
