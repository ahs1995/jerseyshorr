...
function Sidebar({ toggleSidebar, onOpen }) {
  return (
    <aside
      className={`absolute left-0 top-10 z-[100000] h-full w-[350px] bg-[#fff] shadow-md transition-transform duration-500 ${toggleSidebar ? "translate-x-100" : "translate-x-0"}`}
    >
