...
function Cart() {
  ...
  return (
    <div className="py-6">
      <h2 className="mb-6 text-lg font-semibold uppercase text-primary-800">
        your cart
      </h2>
      {/* items*/}
      <div className="mb-8">
        <div className="mb-8 flex justify-between bg-white-50 p-2 text-xs font-semibold uppercase text-primary-800">
          <span>product</span>
          <span>price</span>
        </div>
        {/* items container */}
