      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col gap-4">
          {cartItems.map((item) => (
            ...
            <div
              key={item.jerseyId}
              className="flex flex-col gap-10 border-[1px] border-primary-50 px-2 py-4 md:grid md:grid-cols-4"
            >
              {/* product */}
              ...
              {/* quantity update and total price */}
              <div className="flex items-center justify-between md:col-span-1">
                {/* quantity update box already in product details, no need to repeat */}
                {/* total price */}
                <span className="text-md text-primary-800">
