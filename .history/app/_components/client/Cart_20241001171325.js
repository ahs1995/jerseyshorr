      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col gap-4">
          {cartItems.map((item) => (
            ...
            <div
              key={item.jerseyId}
              className="grid grid-cols-3 gap-4 border-[1px] border-primary-50 px-2 py-4 md:grid-cols-4"
            >
              {/* //////////////////////////// */}
              {/* product image */}
              ...
              {/* /////////////////////////// */}
              <div className="col-span-1 grid grid-rows-2 gap-4 md:col-span-2 md:grid-cols-2 md:grid-rows-1">
                {/* product info */}
