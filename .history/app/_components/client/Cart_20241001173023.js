      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col gap-4">
          {cartItems.map((item) => (
            ...
            <div
              key={item.jerseyId}
              className="grid grid-cols-[auto_1fr_auto] items-start gap-4 border-[1px] border-primary-50 px-2 py-4 md:grid-cols-[auto_repeat(3,_1fr)_auto]"
            >
              {/* //////////////////////////// */}
              {/* product image */}
              ...
              {/* /////////////////////////// */}
              <div className="col-span-1 grid grid-rows-2 md:col-span-3 md:grid-cols-3 md:grid-rows-1">
                {/* product info */}
