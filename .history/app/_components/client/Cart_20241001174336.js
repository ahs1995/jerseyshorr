      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col gap-4">
          {cartItems.map((item) => (
            ...
            <div
              key={item.jerseyId}
              className="grid grid-cols-[auto_1fr_auto] items-start gap-4 border-[1px] border-primary-50 px-2 py-4 md:grid-cols-[auto_1fr_30px_1fr_1fr]"
            >
              {/* //////////////////////////// */}
              {/* product image */}
              ...
              {/* /////////////////////////////// */}
              <div className="hidden justify-self-end border-2 border-primary-800 md:block">
