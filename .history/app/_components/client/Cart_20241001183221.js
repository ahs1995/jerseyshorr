      ...
      <div className="mb-8">
        ...
        <div className="flex flex-col gap-4">
          {cartItems.map((item) => (
            ...
            <div
              key={item.jerseyId}
              className="grid grid-cols-[auto_1fr_auto] items-start gap-4 border-[1px] border-primary-50 px-2 py-4 md:grid-cols-[auto_3fr_1fr_1fr_1fr]"
            >
              {/* product image */}
              ...
              <div className="col-span-1 grid grid-rows-2 justify-self-start md:col-span-2 md:grid-cols-2 md:grid-rows-1">
                {/* product info */}
                ...
                {/* quantity update box */}
                <div className="flex items-start gap-4 md:items-center md:justify-center">
