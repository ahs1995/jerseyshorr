...
function Cart() {
  ...
  return (
    <div className="grid grid-rows-[auto-1fr] justify-center gap-2">
      {/* heading */}
      ...
      <div className="grid grid-cols-1 justify-between lg:grid-cols-[1fr_1fr]">
        ...
        {/* second column */}
        <div className="md:flex md:justify-between lg:max-w-[200px] lg:flex-col lg:items-end lg:justify-start">
          {/* c_first column */}
          <div className="mb-6">
            <Coupons />
          </div>
