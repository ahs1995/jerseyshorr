...
function Cart() {
  ...
  return (
    <div className="grid grid-rows-[auto_1fr] justify-center gap-2">
      ...
      {/* content */}
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr] lg:justify-between lg:gap-16">
        {/*first column*/}
        ...
        {/* second column */}
        <div className="md:grid md:grid-cols-[1fr_1fr] md:gap-16 lg:max-w-[500px] lg:grid-cols-[1fr]">
          {/* c_first column */}
          <div className="mb-6">
            <Coupons />
          </div>
