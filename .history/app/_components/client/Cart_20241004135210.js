...
function Cart() {
  ...
  return (
    <div className="grid grid-rows-[auto_1fr] justify-center gap-2">
      ...
      {/* content */}
      <div className="grid grid-cols-1 justify-between gap-8 lg:grid-cols-[1fr_1fr] lg:gap-16">
        {/* first column */}
        ...
        {/* second column */}
        <div className="md:grid md:grid-cols-[1fr_1fr] md:gap-16 lg:max-w-[500px] lg:flex-col lg:items-end">
          {/* Coupons */}
          <div className="mb-6">
            <Coupons />
          </div>
