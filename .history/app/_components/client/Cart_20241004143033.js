...
function Cart() {
  ...
  return (
    <div className="grid grid-rows-[auto_1fr] justify-center gap-2">
      ...
      {/* content */}
      <div className="grid grid-cols-1 justify-between lg:grid-cols-[1fr_1fr] lg:gap-16">
        {/*first column*/}
        <div className="mb-8 lg:max-w-[500px]">
          ...
          <div className="flex flex-col gap-4">
            {cartItems.map((item) => (
              ...
              >
                ...
                <div className="col-span-1 grid grid-rows-[1fr_auto] md:col-span-2 md:grid-cols-3 md:grid-rows-1">
                  {/* product info */}
                  ...
                  {/* quantity update box */}
                  <div className="flex items-center gap-2 md:items-center md:justify-center">
        ...
        {/* second column */}
        <div className="md:grid md:grid-cols-[1fr_1fr] md:gap-16 lg:max-w-[500px] lg:grid-cols-[1fr] lg:items-end">
          {/* c_first column */}
          <div className="mb-6">
            <Coupons />
          </div>
          ...
          <div className="md:flex md:flex-col">
            <div className="mb-8 border-b-[1px] border-t-[1px] border-primary-50 py-4">
