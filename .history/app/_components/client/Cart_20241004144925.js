...
function Cart() {
  ...
  return (
    <div className="grid grid-rows-[auto_1fr] justify-center gap-4">
      {/* heading */}
      ...
      {/* content */}
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_auto] lg:justify-between">
        {/*first column*/}
        ...
        {/* second column */}
        <div className="md:grid md:grid-cols-[1fr_1fr] md:gap-16 lg:max-w-[400px] lg:grid-cols-[1fr] lg:items-end">
          {/* c_first column */}
          <div className="mb-6">
            <Coupons />
          </div>
