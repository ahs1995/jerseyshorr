  ...
  return (
    <div className="grid grid-rows-[auto_1fr] justify-center gap-2">
      ...
      <div className="grid grid-cols-1 justify-between lg:grid-cols-[1fr_1fr]">
        ...
        {/* second column */}
        <div className="md:flex md:flex-row md:justify-between lg:flex lg:flex-col lg:items-end lg:justify-start">
          {/* c_first column */}
          <div className="mb-6">
            <Coupons />
          </div>
          ...
          {/* c_second column */}
          <div className="md:flex md:w-[300px] md:flex-col lg:w-[400px]">
