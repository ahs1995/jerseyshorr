...
function CheckoutCta() {
  ...
  return (
    <div className="mb-16 flex flex-col gap-4 text-xs capitalize text-primary-800">
      ...
      <div
        className={clsx(
          "transition-max-height overflow-hidden border-2 border-dashed border-primary-100 px-4 py-6 duration-500 ease-in-out",
      ...
      <div
        className={clsx(
          "transition-max-height my-6 flex flex-col gap-6 overflow-hidden border-2 border-dashed border-primary-100 px-4 py-10 duration-500 ease-in-out",
