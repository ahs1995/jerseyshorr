...
function CheckoutCta() {
  ...
  return (
    <div className="bg-white-50 px-4 py-6">
      {/* text contents */}
      ...
      <div className="grid grid-cols-[1fr_1fr] gap-4 px-2">
        <div>
          ...
          <div
            className={clsx(
              "transition-max-height mt-4 w-full overflow-hidden border-2 border-dashed border-primary-100 bg-[#fff] duration-500 ease-in-out",
