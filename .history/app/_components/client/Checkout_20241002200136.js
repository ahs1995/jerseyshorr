...
function Checkout() {
  return (
    <div>
      <h2 className="text-md mb-6 font-bold uppercase text-primary-800 xl:mb-10 xl:text-center xl:text-2xl">
        checkout
      </h2>
      {/* CTA */}
      <div className="mb-16 flex flex-col gap-3 text-xs capitalize text-primary-800">
