...
function Checkout() {
  return (
    <div>
      {/* heading */}
      <div className="mb-6 flex items-center justify-center bg-primary-50 py-2">
        <h2 className="text-center text-lg font-bold uppercase text-primary-800 xl:mb-10 xl:text-2xl">
          checkout
        </h2>
      </div>
