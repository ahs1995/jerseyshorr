...
function Checkout() {
  return (
    <div>
      <div className="justify-center lg:grid lg:grid-rows-[auto_1fr]">
        {/* heading */}
        ...
        <div className="grid justify-between lg:grid-cols-[1fr_1fr]">
          {/* first column */}
          <div>
            {/* CTA */}
            <div className="mb-8">
          ...
          {/* second column */}
          <div className="md:flex md:justify-between lg:max-w-[450px] lg:flex-col lg:items-end lg:justify-start">
            {/* c_first column */}
            <div>
              {/* Cart review */}
              <div className="mb-6">
            ...
            <div className="md:flex md:flex-col">
              ...
              <div className="mx-auto w-[300px] text-center md:mt-auto md:text-left lg:mx-0">
                ...
                <p className="text-xs text-primary-400">
                  Ensuring financial and personal details are secure during
                  every transaction.
                </p>
              </div>
            </div>
