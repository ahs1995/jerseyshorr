    ...
    <div className="mx-auto w-[90%] py-8">
      ...
      <div>
        ...
        <div>
          ...
          {/* quantity */}
          <div className="mb-4 flex w-[40%] flex-row items-center justify-evenly gap-4 border-[1px] border-primary-500 py-4 text-lg">
            <span>
              <MinusIcon className="h-5 w-5 text-primary-900" />
            </span>
            <span>1</span>
            <span>
              <PlusIcon className="h-5 w-5 text-primary-900" />
            </span>
          </div>
        </div>
        {/*cta buttons */}
