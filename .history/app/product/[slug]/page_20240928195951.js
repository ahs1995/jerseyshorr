    ...
    <div className="mx-auto w-[90%] py-8">
      ...
      <div>
        ...
        <div>
          ...
          {/* size */}
          <div className="mb-4">
            <h5 className="mb-2 text-xs font-semibold uppercase text-primary-600">
              size:
            </h5>
            {/* generate dynamically */}
          ...
          {/* quantity */}
          <h5 className="mb-2 text-xs font-semibold uppercase">quantity:</h5>
          <div className="mb-4 flex w-[30%] flex-row items-center justify-evenly border-[1px] border-primary-500 py-2 text-lg">
            <span>
