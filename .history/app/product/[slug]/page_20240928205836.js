...
async function page({ params }) {
  ...
  const filledDescription = description.replace(/{(.*?)}/g, (match, key) => {
    const replacements = { name, season, material: style }; // You can add more replacements if needed
    return replacements[key] || match; // If no match, return the placeholder as is
  });
