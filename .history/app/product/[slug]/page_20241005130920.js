    ...
    <div className="mx-auto w-[90%] py-8 lg:py-12 xl:w-[80%]">
      ...
      <div className="md:flex md:gap-10 xl:justify-center">
        ...
        <div className="md:w-1/2">
          <div>
            <h3 className="mb-4 text-lg text-primary-800 md:text-2xl lg:text-3xl">{`${name} [season ${season}]`}</h3>
            {/* price */}
            <div className="mb-8 flex items-center gap-6 text-xl md:text-2xl">
